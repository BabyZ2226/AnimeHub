...
export const WatchStats: React.FC<WatchStatsProps> = ({ stats }) => {
    ...
    <div className="bg-gray-800 rounded-xl p-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-gray-700 rounded-lg p-4">
          <h4 className="text-sm text-gray-400 mb-1">Completed Series</h4>
          <p className="text-2xl font-bold">{stats.completedAnime}</p>
        </div>
        <div className="bg-gray-700 rounded-lg p-4">
          <h4 className="text-sm text-gray-400 mb-1">Total Episodes</h4>
